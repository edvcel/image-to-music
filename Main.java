...
public class Main {
	...
	public static String[] pictures = new String[] {"ColourP", "ModernP", "ImpressP" ,"BaroqueP", "vanEyckP", "PicassoP"};
	...
	public static void main(String[] args) throws IOException {
		...
		for (int m = 0; m < pictures.length; m++) {
		    ...
		    try {
		        f = new File("/home/pi/Java/image-to-music/pixel-images/" + pictures[m] + ".jpg");
		        img = ImageIO.read(f);
		    } catch(IOException e) {
